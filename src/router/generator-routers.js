...
const constantRouterComponents = {
  ...
  'registrationSettings': () => import('@/views/system/registrationSettings/registrationSettings_list'),
  'examinationRegistration': () => import('@/views/office/examinationRegistration'),
  'accountManagement': () => import('@/views/business/accountManagement/accountManagement.vue'),
  // 招聘采集
  'collectionManagement': () => import('@/views/collection/collectionAccountManagement/collectionAccountManagement.vue'),
  // 招聘计划 单位
  'unitUserInfo': () => import('@/views/recruitmentPlan/unit/unitUserInfo.vue'),
  // 招聘计划 委人事处
  'planAuditIndex': () => import('@/views/recruitmentPlan/office/planAuditList.vue')
}
...
export const generatorDynamicRouter = (data) => {
  return new Promise((resolve, reject) => {
    ...
    // routers.push(registrationSettings)
